...
const SuccessPicture = (props) => {  
    return (
        ...
        <path style={{stroke: 'none',fillRule: 'nonzero',fill: '#2ecc70',fillOpacity:1}} d="M 72 144 C 32.234375 144 0 111.765625 0 72 C 0 32.234375 32.234375 0 72 0 C 111.765625 0 144 32.234375 144 72 C 144 111.765625 111.765625 144 72 144 Z M 72 144 "/>
